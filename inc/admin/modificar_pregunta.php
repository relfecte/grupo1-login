...
if (isset($_GET['pregunta_id']) && is_numeric($_GET['pregunta_id'])) {
    ...
    // Asegurar que $pregunta sea un array y extraer su contenido
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $patron_pregunta = "/^[a-zA-Z0-9\s\?¡!.,]{1,100}$/"; // Se agregaron más caracteres permitidos
    $patron_opcion = "/^[a-zA-Z0-9\s\?¡!.,]{1,40}$/";

    validarPatrones($patron_categoria, $categoria, "La categoría debe tener entre 3 y 40 caracteres alfabéticos.");
    validarPatrones($patron_pregunta, $pregunta_texto, "La pregunta debe tener entre 1 y 100 caracteres.");
    validarPatrones($patron_opcion, $opcion_correcta, "La opción correcta debe tener entre 1 y 40 caracteres.");
    validarPatrones($patron_opcion, $opcion2, "La opción 2 debe tener entre 1 y 40 caracteres.");
    validarPatrones($patron_opcion, $opcion3, "La opción 3 debe tener entre 1 y 40 caracteres.");
    validarPatrones($patron_opcion, $opcion4, "La opción 4 debe tener entre 1 y 40 caracteres.");
